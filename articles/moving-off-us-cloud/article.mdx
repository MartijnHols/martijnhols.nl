...
export const meta = {
  ...
  socials: [
    ...
    'https://news.ycombinator.com/item?id=43351606',
  ],
}
...
Instead, I went with Scaleway Container Registry](https://www.scaleway.com/en/container-registry/). It's fully managed, straightforward to use, and keeps my images in the EU. In the end it took me only a few hours to setup and is set to cost me [less than €1 per month](/tooltip "The total cost depends on the amount of data pulled. Storage alone is less than €0.20 per month."). Can't beat that.
...
Replacing Docker Hub required more research, mainly because I hadn't set up a custom registry or persistent storage before—something I should have solved ages ago.
