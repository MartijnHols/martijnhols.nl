  ...
  return (
    ...
    >
      ...
      <div style={{ marginTop: '1em' }}>
        <a
          href="/blog/demo/google-translate-crashes-ternary-repro"
          target="_blank"
        >
          Open in new window
        </a>
        {' | '}
        <a href="https://github.com/MartijnHols/martijnhols.nl/tree/main/pages/blog/demo/google-translate-crashes-ternary-repro.tsx">
          Source
        </a>
        {' | '}
